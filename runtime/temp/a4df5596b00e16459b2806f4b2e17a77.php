...
layui.use(['jquery', 'laydate', 'upload'], function() {
    ...
    upload.render({
        elem: '.layui-upload',
        url: '<?php echo url("admin/annex/upload?thumb=no&water=no&group=temp"); ?>'
        ,method: 'post'
