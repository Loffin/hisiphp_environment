<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/hook/index.php";i:1535793512;s:70:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/layout.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/header.php";i:1535793512;s:74:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/menu.php";i:1535793512;s:75:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/layui.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        ...
        <a data-href="<?php echo url('status?val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
...
<script type="text/html" id="statusTpl">
    <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?id={{ d.id }}">
</script>
