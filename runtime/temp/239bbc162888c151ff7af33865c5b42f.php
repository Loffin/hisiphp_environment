<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/module/theme.php";i:1535793512;s:70:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/layout.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/header.php";i:1535793512;s:74:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/menu.php";i:1535793512;s:75:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/layui.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <li>
        <img src="<?php echo $vo['thumb']; ?>" width="150" height="150">
        <dl>
            <dd>名称：<span class="mcolor"><?php echo $vo['title']; ?></span></dd>
            <dd>作者：<span class="mcolor2"><?php echo $vo['author']; ?></span></dd>
            <dd>版本：<span class="mcolor2"><?php echo $vo['version']; ?></span></dd>
            <dd>时间：<span class="mcolor2"><?php echo $vo['time']; ?></span></dd>
            <dt><?php if($vo['name'] == $data_info['theme']): ?><a class="layui-btn layui-btn-normal layui-btn-sm layui-btn-disabled">默认主题</a><?php else: ?><a data-href="<?php echo url('setDefaultTheme?id='.$data_info['id'].'&theme='.$vo['name']); ?>" class="layui-btn layui-btn-sm j-ajax">设为默认</a><?php endif; if(isset($vo['identifier']) && !empty($vo['identifier'])): ?><a href="<?php echo url('upgrade/lists?app_name='.$data_info['name'].'&app_type=theme&app_version='.$vo['version'].'&identifier='.$vo['identifier']); ?>" class="layui-btn layui-btn-primary layui-btn-sm">更新</a><?php endif; ?><a data-href="<?php echo url('delTheme?id='.$data_info['id'].'&theme='.$vo['name']); ?>" class="layui-btn layui-btn-primary layui-btn-sm j-ajax" title="删除之后将无法恢复！您确定要执行删除吗？">删除</a></dt>
        </dl>
    </li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
