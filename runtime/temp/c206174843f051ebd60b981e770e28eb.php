<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/member/level.php";i:1535793512;s:58:"/Users/huangpeng/program/hisiphp/app/admin/view/layout.php";i:1535793512;s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/block/header.php";i:1535793512;s:62:"/Users/huangpeng/program/hisiphp/app/admin/view/block/menu.php";i:1535793512;s:63:"/Users/huangpeng/program/hisiphp/app/admin/view/block/layui.php";i:1535793512;s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('addLevel'); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('status?table=admin_member_level&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?table=admin_member_level&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('delLevel'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
...
<script type="text/html" title="状态模板" id="statusTpl">
    <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?table=admin_member_level&id={{ d.id }}">
</script>

<script type="text/html" title="默认设置模板" id="defaultTpl">
    <input type="checkbox" name="default" value="{{ d.default }}" lay-skin="switch" lay-filter="switchStatus" lay-text="是|否" {{ d.default == 1 ? 'checked' : '' }} data-href="<?php echo url('setDefault'); ?>?id={{ d.id }}">
</script>

<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('editLevel'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
    <a href="<?php echo url('delLevel'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-danger j-tr-del">删除</a>
</script>
