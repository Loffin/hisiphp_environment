<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/config/index.php";i:1535793512;s:70:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/layout.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/header.php";i:1535793512;s:74:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/menu.php";i:1535793512;s:75:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/layui.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
...
<?php endif; switch($tab_type): case "1": ?>
    ...
    <div class="layui-btn-group fl">
        <a href="<?php echo url('add?group='.input('param.group')); ?>" class="layui-btn layui-btn-primary layui-icon layui-icon-add-circle-fine">&nbsp;添加</a>
        <a data-href="<?php echo url('status?table=admin_config&val=1'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-play" data-table="dataTable">&nbsp;启用</a>
        <a data-href="<?php echo url('status?table=admin_config&val=0'); ?>" class="layui-btn layui-btn-primary j-page-btns layui-icon layui-icon-pause" data-table="dataTable">&nbsp;禁用</a>
        <a data-href="<?php echo url('del'); ?>" class="layui-btn layui-btn-primary j-page-btns confirm layui-icon layui-icon-close red">&nbsp;删除</a>
    </div>
</div>
...
<script type="text/html" title="状态模板" id="statusTpl">
    <input type="checkbox" name="status" value="{{ d.status }}" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|关闭" {{ d.status == 1 ? 'checked' : '' }} data-href="<?php echo url('status'); ?>?table=admin_config&id={{ d.id }}">
</script>

<script type="text/html" title="排序模板" id="sortTpl">
    <input type="text" class="layui-input j-ajax-input input-sort" onkeyup="value=value.replace(/[^\d]/g,'')" value="{{ d.sort }}" data-value="{{ d.id }}" data-href="<?php echo url('sort'); ?>?table=admin_config&id={{ d.id }}">
</script>

<script type="text/html" title="操作按钮模板" id="buttonTpl">
    <a href="<?php echo url('edit'); ?>?id={{ d.id }}" class="layui-btn layui-btn-xs layui-btn-normal">修改</a>
