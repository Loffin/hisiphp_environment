<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:78:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/module/install.php";i:1535793512;s:70:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/layout.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/header.php";i:1535793512;s:74:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/menu.php";i:1535793512;s:75:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/layui.php";i:1535793512;s:76:"/Users/huangpeng/program/hisiphp_environment/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
...
<div class="page-form">
    <?php if($data_info['module_depend']): ?>
    ...
    <div class="layui-form-item">
        ...
        <table class="layui-table ml30" lay-even="" lay-skin="row">
            ...
            <tbody>
                <?php if(is_array($data_info['module_depend']) || $data_info['module_depend'] instanceof \think\Collection || $data_info['module_depend'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data_info['module_depend'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                <tr>
                    <td><?php echo $v[0]; ?></td>
                    <td><?php echo $v[1]; ?></td>
                    <td><?php echo $v[5]; ?></td>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <button type="submit" <?php if($error): ?>class="layui-btn layui-btn-disabled" disabled<?php else: ?>class="layui-btn"<?php endif; ?> lay-submit="" lay-filter="formSubmit">立即安装</button>
