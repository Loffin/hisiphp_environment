<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/system/index.php";i:1535793512;s:58:"/Users/huangpeng/program/hisiphp/app/admin/view/layout.php";i:1535793512;s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/block/header.php";i:1535793512;s:62:"/Users/huangpeng/program/hisiphp/app/admin/view/block/menu.php";i:1535793512;s:63:"/Users/huangpeng/program/hisiphp/app/admin/view/block/layui.php";i:1535793512;s:64:"/Users/huangpeng/program/hisiphp/app/admin/view/block/footer.php";i:1535793512;}*/ ?>
    ...
    <?php if(is_array($data_list) || $data_list instanceof \think\Collection || $data_list instanceof \think\Paginator): $i = 0; $__LIST__ = $data_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;switch($v['type']): case "textarea": ?>
        ...
        <?php break; case "checkbox": ?>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><?php echo $v['title']; ?></label>
                <div class="layui-input-inline">
                    <?php if(is_array($v['options']) || $v['options'] instanceof \think\Collection || $v['options'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['options'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><input type="checkbox" name="id[<?php echo $v['id']; ?>][]" value="<?php echo $key; ?>" title="<?php echo $vv; ?>" lay-skin="primary" <?php if(in_array($key, $v['value'])): ?>checked<?php endif; ?>>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <div class="layui-form-mid layui-word-aux"><?php echo htmlspecialchars_decode($v['tips']); ?><br>调用方式：<code>config('<?php if(isset($v['module'])): ?>module_<?php endif; ?><?php echo input('param.group', 'base'); ?>.<?php echo $v['name']; ?>')</code></div>
            </div>
